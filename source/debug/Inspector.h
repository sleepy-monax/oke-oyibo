...
namespace MM
{
    ...
    public:
        ...
        {
            return registerComponent<TComponent>(name, components::inspect<TComponent>);
        }
        ...
        void display_entity_list(Registry &registry, std::set<ComponentTypeID> &comp_list)
        {
